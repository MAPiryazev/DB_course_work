...
INSERT INTO
    products (name, price, description, warranty_period, manufacturer_id, stock_quantity)
VALUES
    ('Шина для велосипеда 26x2.1', 30.0, 'Шина для горного велосипеда, подходит для любых условий.', 12, 1, 10),
    ('Цепь велосипедная Shimano HG54', 20.0, 'Цепь 10 скоростей, подходит для MTB и шоссейных велосипедов.', 6, 2, 15),
    ('Велосипедное седло Brooks B17', 80.0, 'Классическое кожаное седло для комфортной езды.', 24, 3, 10),
    ('Тормозные колодки Avid BB5', 15.0, 'Надежные тормозные колодки для дисковых тормозов.', 6, 4, 10),
    ('Педали Shimano SPD PD-M520', 50.0, 'Педали с двойным креплением для горных и шоссейных велосипедов.', 12, 2,10);
